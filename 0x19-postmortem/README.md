...
approximately 06:07 Greenwich Meridian Time (GMT+1), an outage occurred on an isolated
...
Bug debugger Uzi (BDU... as in my actual initials... made that up on the spot, pretty
good, huh?) encountered the issue upon opening the project and being, well, instructed to
address it, roughly 19:20 GMT. He promptly proceeded to undergo solving the problem.
...
[0-strace_is_your_friend.pp](https://github.com/SamuelAmiaka/alx-system_engineering-devops/blob/master/0x17-web_stack_debugging_3/0-strace_is_your_friend.pp)
